...
<head>
    ...
    <title>{{ trans('emails/stages/finish.title') }}</title>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="450" class="c13">
                ...
                <tr>
                    <td class="c8">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td class="c2">{{ trans('emails/stages/finish.header') }}</td>
                            </tr>
                            <tr>
                                <td class="c3">{{ trans('emails/info.dear') }} {{$name}},</td>
                            </tr>
                            <tr>
                                <td align="center"><img src="{{ asset('images/build/finish.png') }}" alt="Dragon Lancers Creative Agency Finish" width="100%" class="c1" /></td>
                            </tr>
                            <tr>
                                <td class="c4">
                                   {{ trans('emails/stages/finish.body') }}
                                </td>
                            </tr>
                            <tr>
                                <td class="c4">
                                    {{ trans('emails/stages/finish.thx') }}
                                </td>
                            </tr>
                            <tr>
