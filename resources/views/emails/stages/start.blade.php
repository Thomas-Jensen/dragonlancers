...
<head>
    ...
    <title>{{ trans('emails/stages/start.title') }}</title>
    ...
    <tr>
        <td class="c14">
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="450" class="c13">
                <tr>
                    <td align="center"><img src="{{ asset('images/build/mailheader.jpg') }}" alt="Dragon Lancers Creative Agency" width="100%" class="c1" /></td>
                </tr>
                <tr>
                    <td class="c8">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td class="c2">{{ trans('emails/stages/start.header') }}</td>
                            </tr>
                            <tr>
                                <td class="c3">{{ trans('emails/info.dear') }} {{$name}},</td>
                            </tr>
                            <tr>
                                <td align="center"><img src="{{ asset('images/build/start.png') }}" alt="Dragon Lancers Creative Agency Start" width="100%" class="c1" /></td>
                            </tr>
                            <tr>
                                <td class="c4">
                                   {{ trans('emails/stages/start.body') }}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="25%" align="right">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td><a href="https://www.facebook.com/DragonLancers"><img src="{{ asset('images/build/facebook.png') }}" width="50" height="50" class="c1" border="0" alt="Facebook" /></a></td>
                                            <td class="c10" width="20"> </td>
                                            <td><a href="https://twitter.com/dragonlancersco"><img src="{{ asset('images/build/twitter.png') }}" width="50" height="50" class="c1" border="0" alt="Twitter" /></a></td>
                                            <td class="c10" width="20"> </td>
                                            <td><a href="https://plus.google.com/111624196448495342344"><img src="{{ asset('images/build/googleplus.png') }}" width="50" height="50" class="c1" border="0" alt="Google+" /></a></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
