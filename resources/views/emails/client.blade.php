...
<head>
    ...
    <title>{{ trans('emails/client.title') }}</title>
                ...
                <tr>
                    <td class="c8">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td class="c4">{{ trans('emails/client.intro') }}</td>
                            </tr>
                            <tr>
                                <td class="c4">{{ trans('emails/client.login') }} {{ $email }}</td>
                            </tr>
                            <tr>
                                <td class="c4">{{ trans('emails/client.password') }} {{ $code }}</td>
                            </tr>
                            <tr>
                                <td class="c4">{{ trans('emails/client.url') }}</td>
                            </tr>
                            <tr>
